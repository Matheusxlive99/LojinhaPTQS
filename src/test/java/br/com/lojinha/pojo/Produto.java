...
public class Produto {
    ...
    public Produto(String marcaInicial, Tamanho tamanhoInicial){
        //Definir comandos que serão iniciados durante a instaciação
    ...
    public void setValor(double novoValor){
        if (novoValor > 0) {
            ...
            throw new IllegalArgumentException("Valores devem ser maiores do que 0");    //Exceção de argumento inválido
        }
    }
